      ...
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        ...
        <div className="flex flex-wrap -m-4">
          {projects.map((project) => (
            ...
            >
              <div
                className="flex relative h-72 rounded"
                style={{ borderRadius: "20px" }}
              >
                <img
                  alt="gallery"
                  ...
                  src={project.image}
                />
                <div className="px-8 py-10 relative z-10 w-full border-4 dark:border-gray-800 opacity-0 text-white hover:opacity-100 bg-gray-500 dark:bg-gray-900 dark:hover:opacity-100">
